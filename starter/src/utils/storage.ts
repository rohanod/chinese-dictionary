...
export function updatePersonalList(listId: string, updates: Partial<Pick<PersonalList, 'name' | 'words'>>): PersonalList | null {
  const data = getStorageData()
...
export { type PersonalList, type PersonalListsData }