...
declare module 'hanzi-writer' {
  ...
  export interface HanziWriterOptions {
    ...
    charDataLoader?: (char: string, onComplete: (data: CharacterJson) => void) => void
  ...
  export default class HanziWriter {
    static create(target: string | HTMLElement, character: string, options?: HanziWriterOptions): HanziWriter
    static loadCharacterData(character: string, options?: Partial<HanziWriterOptions>): Promise<CharacterJson>
    ...
    highlightStroke(strokeNum: number, options?: AnimationOptions): Promise<void>
    ...
    updateColor(colorName: string, colorVal: string, options?: { onComplete?: () => void; duration?: number }): void
  }
}